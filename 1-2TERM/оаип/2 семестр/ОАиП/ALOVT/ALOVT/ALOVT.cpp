...
int main()     //
{
	...
	int *pi = (int*)&k;
	system("CLS");
	printf("\nисходное значение введенного числа float    %+8.4f\n\n", k);
	printf("значение содержимого разрядной сетки float в 16 с/с    %X\n\n", *pi);

	printf("представление числа в разрядной сетке\n");
	...
	printf("потетрадное представление числа\n");
