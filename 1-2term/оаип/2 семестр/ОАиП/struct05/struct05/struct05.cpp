...
// в проекте используетс€ массив структур дл€ демонстрации 
// создани€ и работы с библиотечным каталогом
...
// вариант 1 - использу€ статические массивы данных
...
// вариант 2 - использу€ указатели на структуру (динамические массивы данных)
...
//	lib = (book **)calloc(1, sizeof(book*)*kol);  // {nullptr};
//	do              // цикл вып-с€ до тех пор пока выражение истинно
//	{               // т.е. пока не введена пуста€ строка (фамили€) 
//		fflush(stdin);
//		printf("\n¬ведите фамилию автора: ");
//		gets(bk->avt);
//		if(strcmp(bk->avt, ""))       // если не пустой ввод
