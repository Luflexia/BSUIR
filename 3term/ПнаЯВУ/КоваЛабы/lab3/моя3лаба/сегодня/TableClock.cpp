...
TableClock::TableClock(std::string type, int id, string brand, double price, string mechanism, bool hasAlarm)
    : MechanicalWatch(type, id, brand, price, mechanism), hasAlarm(hasAlarm) {}
