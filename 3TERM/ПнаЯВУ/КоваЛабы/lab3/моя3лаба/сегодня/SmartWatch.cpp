...
SmartWatch::SmartWatch(string type, int id, string brand, double price, string displayType, string features)
    : ElectronicWatch(type, id, brand, price, displayType), features(features) {}
