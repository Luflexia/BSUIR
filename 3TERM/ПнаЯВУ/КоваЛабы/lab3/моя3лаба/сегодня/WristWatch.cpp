...
WristWatch::WristWatch(std::string type, int id, string brand, double price, string mechanism, string strapType)
    : MechanicalWatch(type, id, brand, price, mechanism), strapType(strapType) {}
