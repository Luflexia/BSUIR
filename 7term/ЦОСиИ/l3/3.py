...
def load_and_preprocess_image(image_path="/Users/admin/PycharmProjects/PytSosi_now/L2/pics/5.jpg"):
...
def main():
    ...
    visualize_rotated_objects(rotated_objects, "из L2 изображения")
