...
HD_PWD='C:/Users/dw800/Desktop/3 lab4/lab4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ShiftRegister_1Hz_Top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ShiftRegister_1Hz_Top.tcl -notrace
