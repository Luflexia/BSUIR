...
HD_PWD='D:/APCU/lab4/lab4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_register.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_register.tcl -notrace
