...
HD_PWD='D:/APCU/lab4/lab4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_register.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_register.tcl
